...
public abstract class AbstractExplanationTest
{
	...
	{
		final OWLAxiom[] axioms = { OWL.equivalentClasses(A, OWL.Thing), OWL.comment(B, "Annotation only class") };
	...
	{
		final OWLAxiom[] axioms = { OWL.subClassOf(A, OWL.Thing), OWL.subClassOf(B, A), OWL.comment(B, "Annotation only class") };
	...
	public void anonymousIndividualPropertyAssertion() throws Exception
	{
		...
		final OWLAxiom[] axioms = { OWL.propertyAssertion(a, p, anon1), OWL.classAssertion(anon1, A), OWL.subClassOf(OWL.some(p, A), B) };
	...
	{
		final OWLAxiom[] axioms = { OWL.equivalentClasses(A, OWL.Thing), OWL.declaration(B) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subClassOf(B, A), OWL.declaration(p) };

		setupGenerators(Arrays.asList(axioms));
		testExplanations(OWL.subClassOf(OWL.and(B, OWL.some(p, OWL.Thing)), A), 0, new OWLAxiom[] { axioms[0] });
	}

	@Test
	public void disjointRange() throws Exception
	{
		final OWLAxiom[] axioms = { OWL.subClassOf(A, OWL.some(p, B)), OWL.range(p, C), OWL.disjointClasses(B, C) };

		final OWLAxiom axiom = OWL.equivalentClasses(A, OWL.Nothing);
		final OWLAxiom[] explanation = new OWLAxiom[] { OWL.subClassOf(A, OWL.some(p, B)), OWL.range(p, C), OWL.disjointClasses(B, C) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subClassOf(A, OWL.some(p, B)), OWL.range(p, C), OWL.subClassOf(B, D), OWL.disjointClasses(D, C), OWL.subClassOf(A, E), OWL.subClassOf(B, F) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subClassOf(A, B), OWL.subClassOf(A, C), OWL.disjointClasses(B, C) };
	...
	public void multipleEquivalentClasses() throws Exception
	{
		...
		final OWLAxiom[] axioms = { OWL.equivalentClasses(A, C), OWL.subClassOf(A, D), OWL.subClassOf(D, E), OWL.subClassOf(B, E), OWL.equivalentClasses(A, B),
	...
	{
		final OWLAxiom[] axioms = { OWL.classAssertion(a, A), OWL.classAssertion(b, B), OWL.propertyAssertion(a, p, b), SWRL.rule(SWRL.antecedent(SWRL.classAtom(A, x)), SWRL.consequent(SWRL.classAtom(B, x))), SWRL.rule(SWRL.antecedent(SWRL.classAtom(B, x), SWRL.propertyAtom(p, x, y), SWRL.classAtom(B, y)), SWRL.consequent(SWRL.classAtom(C, x))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subPropertyOf(q, p), OWL.propertyAssertion(a, q, b), OWL.classAssertion(b, B), SWRL.rule(SWRL.antecedent(SWRL.propertyAtom(p, x, y), SWRL.classAtom(B, y)), SWRL.consequent(SWRL.classAtom(A, x))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.inverseProperties(q, p), OWL.propertyAssertion(b, q, a), OWL.classAssertion(b, B), SWRL.rule(SWRL.antecedent(SWRL.propertyAtom(p, x, y), SWRL.classAtom(B, y)), SWRL.consequent(SWRL.classAtom(A, x))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.classAssertion(a, A), SWRL.rule(SWRL.antecedent(SWRL.classAtom(A, x)), SWRL.consequent(SWRL.classAtom(B, x), SWRL.classAtom(C, x))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.propertyAssertion(a, p, b), SWRL.rule(SWRL.antecedent(SWRL.propertyAtom(p, x, y)), SWRL.consequent(SWRL.classAtom(A, x), SWRL.classAtom(B, y))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.propertyAssertion(a, p, b), OWL.classAssertion(b, B), SWRL.rule(SWRL.antecedent(SWRL.classAtom(OWL.some(p, B), x)), SWRL.consequent(SWRL.classAtom(C, x))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.classAssertion(a, A), OWL.propertyAssertion(a, dp, OWL.constant(9)), SWRL.rule(SWRL.antecedent(SWRL.classAtom(A, x), SWRL.propertyAtom(dp, x, dx), SWRL.lessThan(dx, SWRL.constant(10))), SWRL.consequent(SWRL.classAtom(B, x))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.classAssertion(a, A), OWL.propertyAssertion(a, dp, OWL.constant(9)), SWRL.rule(SWRL.antecedent(SWRL.classAtom(A, x), SWRL.propertyAtom(dp, x, dx), SWRL.greaterThan(dx, SWRL.constant(5)), SWRL.lessThan(dx, SWRL.constant(10))), SWRL.consequent(SWRL.classAtom(B, x))) };
	...
	public void ruleBuiltinTest3() throws Exception
	{
		...
		final OWLAxiom[] axioms = { OWL.propertyAssertion(a, dp, OWL.constant("2009-01-02", XSD.DATE)), SWRL.rule(SWRL.antecedent(SWRL.propertyAtom(dp, x, dx), SWRL.builtIn(SWRLBuiltInsVocabulary.DATE, dx, y, m, d)), SWRL.consequent(SWRL.propertyAtom(year, x, y), SWRL.propertyAtom(month, x, m), SWRL.propertyAtom(day, x, d))) };

		setupGenerators(Arrays.asList(axioms));

		testExplanations(OWL.propertyAssertion(a, year, OWL.constant(2009)), 1, new OWLAxiom[] { axioms[0], axioms[1] });
	}

	@Test
	public void userDefinedDatatype1() throws Exception
	{
		final OWLAxiom[] axioms = { OWL.classAssertion(a, A), OWL.propertyAssertion(a, dp, OWL.constant(9)), OWL.equivalentClasses(B, OWL.and(A, OWL.some(dp, OWL.restrict(XSD.INTEGER, OWL.maxExclusive(10))))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.classAssertion(a, A), OWL.subClassOf(A, OWL.and(OWL.max(dp, 1), OWL.some(dp, OWL.restrict(XSD.INTEGER, OWL.minExclusive(10))))), OWL.equivalentClasses(B, OWL.and(OWL.min(dp, 1), OWL.all(dp, OWL.restrict(XSD.INTEGER, OWL.minExclusive(5))))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.classAssertion(a, A), OWL.propertyAssertion(a, dp, OWL.constant(9)), OWL.equivalentClasses(B, OWL.and(A, OWL.some(dp, dt))), OWL.datatypeDefinition(dt, OWL.restrict(XSD.INTEGER, OWL.maxExclusive(10))) };
	...
	{
		final OWLAxiom[] axioms = { OWL.propertyAssertion(a, dp, OWL.constant(1)), OWL.propertyAssertion(a, dp, OWL.constant(2)), OWL.equivalentClasses(A, OWL.some(dp, dt)), OWL.datatypeDefinition(dt, OWL.oneOf(OWL.constant(1), OWL.constant(2), OWL.constant(3))) };

		setupGenerators(Arrays.asList(axioms));

		testExplanations(OWL.classAssertion(a, A), 0, new OWLAxiom[] { axioms[0], axioms[2], axioms[3] }, new OWLAxiom[] { axioms[1], axioms[2], axioms[3] });
	}

	@Test
	public void transitiveProperty() throws Exception
	{
		final OWLAxiom[] axioms = { OWL.transitive(p), OWL.propertyAssertion(a, p, b), OWL.propertyAssertion(b, p, c), OWL.equivalentClasses(A, OWL.value(p, c)) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subPropertyOf(new OWLObjectProperty[] { p, q }, r), OWL.propertyAssertion(a, p, b), OWL.propertyAssertion(b, q, c) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subPropertyOf(new OWLObjectProperty[] { p, q }, r), OWL.propertyAssertion(a, p, b), OWL.propertyAssertion(b, q, c), OWL.equivalentClasses(A, OWL.some(r, OWL.Thing)) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subPropertyOf(p, r), OWL.subPropertyOf(r, q), OWL.propertyAssertion(a, p, b) };

		setupGenerators(Arrays.asList(axioms));

		testExplanations(OWL.propertyAssertion(a, r, b), 0, new OWLAxiom[] { axioms[0], axioms[2] });
	...
	{
		final OWLAxiom[] axioms = { OWL.range(dp, XSD.BYTE), OWL.range(dp, XSD.NON_POSITIVE_INTEGER), OWL.range(dp, XSD.NON_NEGATIVE_INTEGER), OWL.subClassOf(A, OWL.min(dp, 1)), OWL.classAssertion(a, A) };

		setupGenerators(Arrays.asList(axioms));

		testExplanations(OWL.propertyAssertion(a, dp, OWL.constant(0)), 0, new OWLAxiom[] { axioms[1], axioms[2], axioms[3], axioms[4] });
	}

	@Test
	public void subPropertiesOfFunctionalDataProperty() throws Exception
	{
		final OWLAxiom[] axioms = { OWL.functional(dp), OWL.subPropertyOf(dq, dp), OWL.subPropertyOf(dr, dp), OWL.propertyAssertion(a, dq, OWL.constant(1)), OWL.classAssertion(a, OWL.some(dr, XSD.INTEGER)) };

		setupGenerators(Arrays.asList(axioms));

		testExplanations(OWL.propertyAssertion(a, dp, OWL.constant(1)), 0, new OWLAxiom[] { axioms[1], axioms[3] });
	...
	public void simpleSubClass() throws Exception
	{
		...
		// not be used
		final OWLAxiom[] axioms = { OWL.subClassOf(A, B), OWL.subClassOf(B, C), OWL.subClassOf(A, OWL.all(p, B)) };
	...
	public void simpleType() throws Exception
	{
		...
		// on explanations. the last axiom is to ebsure the EL classifier will
		// not be used
		final OWLAxiom[] axioms = { OWL.classAssertion(a, A), OWL.subClassOf(A, B), OWL.subClassOf(A, OWL.all(p, B)) };
	...
	public void simplePropertyAssertion() throws Exception
	{
		...
		final OWLAxiom[] axioms = { OWL.propertyAssertion(a, p, b) };
	...
	{
		// this test case is to check the effect of hasObviousPropertyValue
		final OWLAxiom[] axioms = { OWL.propertyAssertion(a, p, b), OWL.subPropertyOf(p, q) };
	...
	{
		final OWLAxiom[] axioms = { OWL.functional(p), OWL.subClassOf(C, OWL.min(p, 2)) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subClassOf(A, OWL.some(p, B)), OWL.domain(p, OWL.or(C, D)), OWL.disjointClasses(A, C) };
	...
	{
		final OWLAxiom[] axioms = { OWL.subClassOf(A, OWL.some(p, B)), OWL.range(p, OWL.or(C, D)), OWL.disjointClasses(B, C), OWL.disjointClasses(B, D) };
	...
	public void differentFromAndFunctionality() throws Exception
	{
		...
		final OWLAxiom[] axioms = { OWL.functional(p), OWL.propertyAssertion(a, p, b), OWL.propertyAssertion(a, p, c), OWL.propertyAssertion(a, p, d), OWL.differentFrom(b, c), OWL.differentFrom(c, d) };
