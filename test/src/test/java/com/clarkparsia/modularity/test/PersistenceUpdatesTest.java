...
public class PersistenceUpdatesTest
{
	...
	public void testPersistenceRemoves(String inputOnt) throws IOException
	{
		...
		try
		{
			...
			final List<OWLAxiom> axiomsToRemove = new ArrayList<OWLAxiom>(TestUtils.selectRandomAxioms(ontology, 1));
	...
	public void testAllowedUpdates(String inputOnt) throws IOException
	{
		...
		try
		{
			...
			final List<OWLAxiom> axiomsToRemove2 = new ArrayList<OWLAxiom>(TestUtils.selectRandomAxioms(ontology, 1));
