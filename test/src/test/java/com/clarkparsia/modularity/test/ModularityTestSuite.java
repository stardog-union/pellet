...
@SuiteClasses( {
	...
	IncrementalClassifierTest.class,
	SimpleModularityTest.class,
	ModularityUpdateTest.class,
	RandomizedIncrementalClassifierTest.class,
	RandomizedModularityTest.class,
