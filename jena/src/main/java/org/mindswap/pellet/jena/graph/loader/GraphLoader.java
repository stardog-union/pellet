...
public interface GraphLoader
{
	 ...
	 * processed. These problems depend on the order triples are processed and highly unpredictable. Loading the schema first with preprocessing and loading the
